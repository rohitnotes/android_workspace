    ...
    public class FetchWeatherTask extends AsyncTask<String, Void, String[]>{
        ...
        protected String[] doInBackground(String... params) {
            ...
            try {
                ...
                forcastJsonString = NetworkUtils.getResponseFromHttpUrl(weatherURL);

                weatherReport = OpenWeatherJsonUtils.getSimpleWeatherStringsFromJson(MainActivity.this, forcastJsonString);
